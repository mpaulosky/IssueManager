...
{
    [Inject] private ICategoryApiClient CategoryClient { get; set; } = default!;
    [Inject] private IStatusApiClient StatusClient { get; set; } = default!;
    ...
    private async Task CreateCategories()
    {
        ...
        try
        {
            ...
            {
                await CategoryClient.CreateAsync(new CreateCategoryCommand
                {
                    CategoryName = d[0],
    ...
    private async Task CreateStatuses()
    {
        ...
        try
        {
            ...
            {
                await StatusClient.CreateAsync(new CreateStatusCommand
                {
                    StatusName = name,
