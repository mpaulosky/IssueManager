...
<!-- Archived entries older than 30 days (before 2026-03-13). Scribe appends as decisions.md rolls over. -->
...
### 2026-04-12: PR #115 — GitHub Actions Dependency Bump
**By:** Boromir (DevOps)  
**What:** Merged PR #115 bumping three GitHub Actions: create-pull-request v8.1.0 → v8.1.1, github-script v8 → v9, codecov v5 → v6. All CI checks passed; workflow files only (zero app code changes).  
**Why:** Dependabot automated review; major versions confirmed compatible via successful CI execution; low risk patch bump.  
